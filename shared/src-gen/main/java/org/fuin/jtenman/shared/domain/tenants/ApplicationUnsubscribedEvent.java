...
/**
 * A tenant was unsubscribed from an application; the application's Keycloak client was removed from its realm again.
 */
@HasSerializedDataTypeConstant
public final class ApplicationUnsubscribedEvent extends AbstractDomainEvent<TenantRealmId> {

    @Serial
    private static final long serialVersionUID = 1000L;

    /** Unique name used to store the event. */
    public static final EventType EVENT_TYPE = new EventType("ApplicationUnsubscribedEvent");
     ...
     */
    @SuppressWarnings("NullAway.Init")
    protected ApplicationUnsubscribedEvent() {
        super();
    }
    ...
    /**
     * Returns: The application to withdraw access to.
     *
    ...
    public String toString() {
        return Objects.requireNonNull(KeyValueEL.replace("Unsubscribed from application '${application}'",
     ...
     */
    public static final class Builder extends AbstractDomainEvent.Builder<TenantRealmId, ApplicationUnsubscribedEvent, Builder> {
    
        private ApplicationUnsubscribedEvent delegate;
    
        private Builder() {
            super(new ApplicationUnsubscribedEvent());
            delegate = delegate();
        }
    
        /**
         * Sets: The application to withdraw access to.
         *
         ...
         * @return New instance.
         */
        public ApplicationUnsubscribedEvent build() {
            ...
            final ApplicationUnsubscribedEvent result = delegate;
            delegate = new ApplicationUnsubscribedEvent();
