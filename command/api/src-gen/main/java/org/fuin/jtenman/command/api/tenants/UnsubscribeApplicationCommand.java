...
public final class UnsubscribeApplicationCommand extends AbstractAggregateCommand<TenantRealmId, TenantRealmId> {

	@Serial
    private static final long serialVersionUID = 1000L;

    /** Unique name used to store the command. */
    public static final EventType EVENT_TYPE = new EventType("UnsubscribeApplicationCommand");
     ...
     */
    @SuppressWarnings("NullAway.Init")
    protected UnsubscribeApplicationCommand() {
        super();
    }
    ...
    public String toString() {
        return Objects.requireNonNull(KeyValueEL.replace("Unsubscribe from application '${application}'",
     ...
     */
    public static final class Builder extends AbstractAggregateCommand.Builder<TenantRealmId, TenantRealmId, UnsubscribeApplicationCommand, Builder> {
    
        private UnsubscribeApplicationCommand delegate;
    
        private Builder() {
            super(new UnsubscribeApplicationCommand());
            delegate = delegate();
        }
         ...
         * @return New instance.
         */
        public UnsubscribeApplicationCommand build() {
            ...
            final UnsubscribeApplicationCommand result = delegate;
            delegate = new UnsubscribeApplicationCommand();
