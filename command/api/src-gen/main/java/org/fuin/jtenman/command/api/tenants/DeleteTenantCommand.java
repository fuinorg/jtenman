...
public final class DeleteTenantCommand extends AbstractAggregateCommand<TenantRealmId, TenantRealmId> {

	@Serial
    private static final long serialVersionUID = 1000L;

    /** Unique name used to store the command. */
    public static final EventType EVENT_TYPE = new EventType("DeleteTenantCommand");
    ...
    /**
     * Returns: Why the tenant is being deleted.
     *
    ...
    public String toString() {
        return Objects.requireNonNull(KeyValueEL.replace("Delete tenant",
     ...
     */
    public static final class Builder extends AbstractAggregateCommand.Builder<TenantRealmId, TenantRealmId, DeleteTenantCommand, Builder> {
    
        private DeleteTenantCommand delegate;
    
        private Builder() {
            super(new DeleteTenantCommand());
            delegate = delegate();
        }
    
        /**
         * Sets: Why the tenant is being deleted.
         *
         ...
         * @return New instance.
         */
        public DeleteTenantCommand build() {
            ...
            final DeleteTenantCommand result = delegate;
            delegate = new DeleteTenantCommand();
