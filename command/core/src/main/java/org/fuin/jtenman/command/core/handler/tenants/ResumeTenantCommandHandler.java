...
/**
 * Resumes a suspended tenant, from a {@link ResumeTenantCommand}.
 */
@ThreadSafe
public class ResumeTenantCommandHandler implements CommandHandler<ResumeTenantCommand, Result<Void>> {

    private final TenantRepository repository;

    private final ResumeTenantService service;
     ...
     */
    public ResumeTenantCommandHandler(final TenantRepository repository, final ResumeTenantService service) {
    ...
    @Override
    public Class<ResumeTenantCommand> getCommandType() {
        return ResumeTenantCommand.class;
    }

    @Override
    public Result<Void> handle(final CommandExecutionContext context, final ResumeTenantCommand cmd)
