...
/**
 * Verifies that the process side boots and reports itself as healthy. jtenman models no process managers yet, so this asserts the deployable itself stays runnable as the rest of the project grows.
 * <p>
 ...
 */
@Testcontainers
@SpringBootTest(classes = {ProcessServerApplication.class, ProcessServerApplicationIT.PermitAllSecurity.class},
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class ProcessServerApplicationIT {
