...
/**
 * Tests architectural aspects of the all-in-one deployable, and with it everything on its classpath -
 * {@code shared}, {@code starter-common} and the three {@code core}/{@code starter} pairs.
 * <p>
 ...
 * <p>
 * Deliberately duplicated in the three single-sided server modules rather than shared through a test jar:
 * each one scans its own classpath, and {@code combined} does not depend on them, so without a copy there
 * their production sources would go unchecked.
 */
